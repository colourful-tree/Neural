...
# Load vocabulary
vocab_processor_user_id = learn.preprocessing.VocabularyProcessor.restore(os.path.join("/root/tensor_word_space/movie/runs", "vocab_user_id"))
vocab_processor_user_gender = learn.preprocessing.VocabularyProcessor.restore(os.path.join("/root/tensor_word_space/movie/runs", "vocab_user_gender"))
vocab_processor_user_age = learn.preprocessing.VocabularyProcessor.restore(os.path.join("/root/tensor_word_space/movie/runs", "vocab_user_age"))
vocab_processor_user_occupation = learn.preprocessing.VocabularyProcessor.restore(os.path.join("/root/tensor_word_space/movie/runs", "vocab_user_occupation"))
vocab_processor_movie_id = learn.preprocessing.VocabularyProcessor.restore(os.path.join("/root/tensor_word_space/movie/runs", "vocab_movie_id"))
vocab_processor_movie_title = learn.preprocessing.VocabularyProcessor.restore(os.path.join("/root/tensor_word_space/movie/runs", "vocab_movie_title"))
vocab_processor_movie_class = learn.preprocessing.VocabularyProcessor.restore(os.path.join("/root/tensor_word_space/movie/runs", "vocab_movie_class"))
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        saver.restore(sess, "runs/checkpoints/model-179000") 
